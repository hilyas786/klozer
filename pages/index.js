  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content='Trusted Accounting Firm in Malaysia | Advisory & Accounting'
        />
        <link rel='icon' href='/img/klozerlogo.png' />
      </Head>
      {/* Hero card */}
      <main>
        <Hero
                ...
                <div>
                  <div className='mt-6'>
                    ...
                    <p className='mt-4 text-lg text-gray-500'>
                      ...
                      professional services include business incorporation,
                      human resource, and auditing.
                    </p>
                    <div className='mt-6'>
                      <Button
                        href='/contact'
                  ...
                  <blockquote>
                    <div>
                      <p className='text-base text-gray-500'>
                        ...
                        obligations. Klozer have completely handled everything
                        for us.&rdquo;
                      </p>
                    </div>
