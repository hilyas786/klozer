        ...
        <div className='py-[80px] lg:py-32'>
          <div className='relative z-10 mx-auto max-w-7xl pl-4 pr-8 sm:px-6 lg:px-8'>
            ...
            <p className='mt-6 max-w-3xl text-xl text-warm-gray-500'>
              At Klozer, we have a client first approach. We are more than happy
                  ...
                  >
                    ...
                    <div className='sm:col-span-2'>
                      <label
                        ...
                        className='block text-sm font-medium text-warm-gray-900'
                      >
                        What type of company incorporation are you looking for?
                      </label>
                      <div className='mt-1'>
                        <select
                          required
                    ...
                    <div className='sm:col-span-2 sm:flex sm:justify-end'>
                      ...
                      >
                        {isLoading ? (
                          <svg
                            className='animate-spin ml-7 h-5 w-5 text-white'
                            xmlns='http://www.w3.org/2000/svg'
                            fill='none'
                            viewBox='0 0 24 24'
                          >
